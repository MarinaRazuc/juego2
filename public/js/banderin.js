...
var food_object = function (id, type, startx, starty, value) {
	...
	this.item.beginFill(0xFF0000);  //aca se pasaria el color correspondiente (pasado x param)
	this.item.lineStyle(2, 0xFF0000, 1);
	this.item.drawCircle(0, 0, 20);

	this.item.type = 'food_body'; //capaz podriamos especificar el tipo con color
	this.item.id = id;
